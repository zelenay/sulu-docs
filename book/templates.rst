...
.. Note::
    ...
    The notation ``bundle:directory:filename`` is Symfony's naming convention
    for Twig templates. Read `more about template naming`_ in the Symfony
    documentation.
...
|                         | tags                                        |                                         |
+-------------------------+---------------------------------------------+-----------------------------------------+
| |media_selection|       | widget for selecting media (images,         | array containing another array with     |
|                         | documents)                                  | urls for every format                   |
+-------------------------+---------------------------------------------+-----------------------------------------+
| |contact_selection|     | widget for selecting contacts               | ?                                       |
+-------------------------+---------------------------------------------+-----------------------------------------+
| |snippet|               | widget for selecting snippets               | ?                                       |
+-------------------------+---------------------------------------------+-----------------------------------------+
...
.. _more about template naming: http://symfony.com/doc/current/templating.html#template-naming-and-locations
